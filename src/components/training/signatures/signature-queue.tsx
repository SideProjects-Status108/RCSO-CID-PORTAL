    ...
    <section className="space-y-3">
      <header className="flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={() => void load()}
          className="inline-flex items-center gap-1 rounded px-2 py-1 text-xs text-text-secondary hover:bg-bg-subtle hover:text-text-primary"
          disabled={loading}
      ...
      {loading ? (
        <div className="rounded-md border border-border-subtle bg-bg-card px-3 py-4 text-xs text-text-tertiary">
          Loading...
        </div>
      ) : rows.length === 0 ? (
        <div className="rounded-md border border-border-subtle bg-bg-card px-3 py-4 text-xs text-text-tertiary">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 text-sm font-medium text-text-primary">
                      ...
                      <span className="rounded bg-bg-subtle px-1.5 py-0.5 text-[10px] uppercase tracking-wide text-text-tertiary">
